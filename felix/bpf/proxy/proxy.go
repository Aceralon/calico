...
func New(k8s kubernetes.Interface, dp DPSyncer, hostname string, opts ...Option) (Proxy, error) {
	...
	p.svcHealthServer = healthcheck.NewServiceHealthServer(p.hostname, p.recorder, nil)
...
func (r *loggerRecorder) Eventf(regarding runtime.Object, related runtime.Object, eventtype,
	reason, action, note string, args ...interface{}) {
}
